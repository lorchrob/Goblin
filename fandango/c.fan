...
where forall <use_id> in <statement>..<expr>..<id>: exists <dec> in <declaration>: str(<dec>.<id>) == str(<id>) and is_before(<start>, <dec>, <use_id>) ;
...
where forall <decl1> in <declaration>: forall <decl2> in <declaration>: not(str(<decl1>.<id>) == str(<decl2>.<id>)) or <decl1> == <decl2> ;
