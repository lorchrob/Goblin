...
(declare-datatype AC_ELEMENT_ID_EXTENSION (
	(ac_element_id_extension_con0 (des10 _STUB2_GRAMMAR_ELEMENT))
))
(declare-datatype AC_ELEMENT_ID (
	(ac_element_id_con0 (des11 _STUB1_GRAMMAR_ELEMENT))
))
(declare-datatype AC_TOKEN_CONTAINER (
	(ac_token_container_con0 (des12 AC_ELEMENT_ID) (des13 _STUB0_GRAMMAR_ELEMENT) (des14 AC_ELEMENT_ID_EXTENSION) (des15 (Seq Bool)))
))
...
; grammar rules
(
	(ac_token_container AC_TOKEN_CONTAINER ((ac_token_container_con0 ac_element_id _stub0_grammar_element ac_element_id_extension ac_token_element)))
...
(define-fun c16 ((ac_token_container AC_TOKEN_CONTAINER)) Bool 
	(match ac_token_container (
		((ac_token_container_con0 ac_element_id _stub0_grammar_element ac_element_id_extension ac_token_element)
		 true)
	))
)
(constraint (c16 top))
