...
(declare-datatype AC_ELEMENT_ID_EXTENSION (
	(ac_element_id_extension_con0 (des15 _STUB3_GRAMMAR_ELEMENT))
))
(declare-datatype AC_ELEMENT_ID (
	(ac_element_id_con0 (des16 _STUB2_GRAMMAR_ELEMENT))
))
(declare-datatype AC_TOKEN_CONTAINER (
	(ac_token_container_con0 (des17 AC_ELEMENT_ID) (des18 (_ BitVec 8)) (des19 AC_ELEMENT_ID_EXTENSION) (des20 (Seq Bool)))
))
(declare-datatype RG_ID_LIST (
	(rg_id_list_con0 (des21 (_ BitVec 8))) 
	(rg_id_list_con1 (des22 (_ BitVec 8)) (des23 RG_ID_LIST))
))
(declare-datatype RG_ELEMENT_ID_EXTENSION (
	(rg_element_id_extension_con0 (des24 _STUB1_GRAMMAR_ELEMENT))
))
(declare-datatype RG_ELEMENT_ID (
	(rg_element_id_con0 (des25 _STUB0_GRAMMAR_ELEMENT))
))

(synth-fun top () RG_ELEMENT_ID
